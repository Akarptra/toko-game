<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" oninput="validateNoSpace(this)" />
    ...
    <script>
        function validateNoSpace(input) {
            // Menghapus spasi pada username jika ada
